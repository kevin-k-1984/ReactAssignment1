...
export const postFeedback = (firstname, lastname, telnum, email, agree, contactType, message) => (dispatch) => {
    ...
    return fetch(baseUrl + 'feedback', {
        ...
        .then(data => alert(
            ...
            'First name: ' + data.payload.firstname + '\n' +
            'Last name: ' + data.payload.lastname + '\n' +
            'Tel. #: ' + data.payload.telnum + '\n' +
            'Email: ' + data.payload.email + '\n' +
            'Contact me: ' + data.payload.agree + '\n' +
            'Contact by: ' + data.payload.contactType + '\n' +
            'Feedback message: ' + data.payload.message + '\n' +
